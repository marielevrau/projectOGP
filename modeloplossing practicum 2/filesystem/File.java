...
public class File extends DiskItem{
	...
	*/    
    ...
    public boolean canBeTerminated(){
    	...
    	// Note that even though the implementation is not changed, we still need to define this
    	// method in this subclass. If we don't than there is no definitive specification for this method.
	...
	public boolean canHaveAsParentDirectory(Directory directory) {
		// Note that we can simply use the implementation of the superclass.
		// This is only because we, as a programmer, know that we completed the implementation in 
		// the superclass to behave correctly in this case!
		// Were that not the case, then we would write a similar implementation here as in the Directory subclass!
